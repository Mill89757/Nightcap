...
/**
 Reference:
 Record Button
 Link:   https://github.com/samuelbeek/RecordButton
...
class AnimatedButton : UIButton {
    ...
    open var buttonState : AnimatedButtonState = .idle {
        didSet {
            switch buttonState {
            case .idle:
                self.alpha = 1.0
    ...
    public init(frame: CGRect, viewController: UIViewController) {
        
        super.init(frame: frame)
        self.viewController = viewController
        
        self.addTarget(self, action: #selector(AnimatedButton.didTouchDown), for: .touchDown)
        self.addTarget(self, action: #selector(AnimatedButton.didTouchUp), for: .touchUpInside)
        self.addTarget(self, action: #selector(AnimatedButton.didTouchUp), for: .touchUpOutside)
